...
**Spec:** `docs/spark/specs/2026-06-11-visual-companion-final-hardening-fixup-design.md`
...
- Modify: `docs/spark/plans/2026-06-09-visual-companion-issues.md`
...
```bash
cd /Users/drewritter/.codex/worktrees/59f6/spark/tests/brainstorm-server
node server.test.js
```
...
```bash
cd /Users/drewritter/.codex/worktrees/59f6/spark
...
server_id_file=$(find "$TEST_DIR/project/.spark/brainstorm" -name server-instance-id -print 2>/dev/null | head -1)
server_id_value=""
...
In `docs/spark/plans/2026-06-09-visual-companion-issues.md`, replace the disposition rows for A2, D1, D2, D3, and D4 with:
...
```bash
git diff -- skills/brainstorming/visual-companion.md docs/spark/plans/2026-06-09-visual-companion-issues.md
```
...
```bash
git add skills/brainstorming/visual-companion.md docs/spark/plans/2026-06-09-visual-companion-issues.md
...
```bash
git -C /Users/drewritter/.codex/worktrees/59f6/spark-evals rev-parse HEAD
git -C /Users/drewritter/.codex/worktrees/59f6/spark-evals status --short --branch
```

If the eval worktree is not at that path, run the same commands in `/Users/drewritter/prime-rad/spark-evals`.
...
- [ ] Every requirement in `docs/spark/specs/2026-06-11-visual-companion-final-hardening-fixup-design.md` maps to one of the tasks above.
