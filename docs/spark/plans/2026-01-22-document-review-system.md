...
> **For agentic workers:** REQUIRED: Use spark:subagent-driven-development (if subagents available) or spark:executing-plans to implement this plan.
...
**Spec:** docs/spark/specs/2026-01-22-document-review-system-design.md
...
**Dispatch after:** Spec document is written to docs/spark/specs/
...
```markdown
> **For agentic workers:** REQUIRED: Use spark:subagent-driven-development (if subagents available) or spark:executing-plans to implement this plan. Tasks and steps use checkbox (`- [ ]`) syntax for tracking.
```
