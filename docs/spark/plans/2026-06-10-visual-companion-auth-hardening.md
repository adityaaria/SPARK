...
```bash
cd /Users/drewritter/prime-rad/spark/tests/brainstorm-server
node auth.test.js
```
...
```bash
cd /Users/drewritter/prime-rad/spark
...
```bash
cd /Users/drewritter/prime-rad/spark
git check-ignore .spark/brainstorm/.last-token || true
```
...
```bash
cd /Users/drewritter/prime-rad/spark
git check-ignore .spark/brainstorm/.last-token
```

Expected output:

```text
.spark/brainstorm/.last-token
```
...
```bash
node /tmp/spark-pr1720-security-drewritter/probe-pr1720.cjs
```
