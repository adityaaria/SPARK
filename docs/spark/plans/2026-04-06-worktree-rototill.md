...
**Goal:** Make spark defer to native harness worktree systems when available, fall back to manual git worktrees when not, and fix three known finishing bugs.
...
**Spec:** `docs/spark/specs/2026-04-06-worktree-rototill-design.md`
...
**If worktree path is under `.worktrees/` or `worktrees/`:** SPARK created this worktree — we own cleanup.
