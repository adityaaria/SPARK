...
mkdir -p src test docs/spark/plans

# Create a simple implementation plan
cat > docs/spark/plans/implementation-plan.md <<'EOF'
...
I want you to execute the implementation plan at docs/spark/plans/implementation-plan.md using the subagent-driven-development skill.
...
PROMPT="Execute the implementation plan at docs/spark/plans/implementation-plan.md using the subagent-driven-development skill.
...
if grep -q '"name":"Skill".*"skill":"spark:subagent-driven-development"' "$SESSION_FILE"; then
