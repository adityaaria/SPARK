...
## Is this a SPARK issue or a platform issue?
<!-- SPARK is a plugin. Some reported "bugs" are actually issues
     in the underlying platform or model. If you're not sure, try
     reproducing without SPARK installed.

     If the problem persists without SPARK, file the issue with
     your platform instead. -->

- [ ] I confirmed this issue does not occur without SPARK installed
