...
<!-- SPARK core contains general-purpose skills and infrastructure
...
<!-- If this PR adds support for a new harness (IDE, CLI tool, agent
     ...
     A real integration loads the `using-spark` bootstrap at session
...
- [ ] If this is a skills change: I used `spark:writing-skills` and
