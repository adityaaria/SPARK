...
6. **Write design doc** — save to `docs/spark/specs/YYYY-MM-DD-<topic>-design.md` and commit
...
- Write the validated design (spec) to `docs/spark/specs/YYYY-MM-DD-<topic>-design.md`
